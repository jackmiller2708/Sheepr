...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MinimumRequirementsRepository")
 */
class MinimumRequirements
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Post", inversedBy="minimumRequirements", cascade={"persist", "remove"})
