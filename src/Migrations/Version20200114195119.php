 ...
 */
final class Version20200114195119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD views INT NOT NULL, ADD downloads INT NOT NULL');
        $this->addSql('ALTER TABLE screenshots CHANGE post_id post_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP views, DROP downloads');
        $this->addSql('ALTER TABLE screenshots CHANGE post_id post_id INT DEFAULT NULL');
