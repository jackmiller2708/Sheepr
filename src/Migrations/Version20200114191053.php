 ...
 */
final class Version20200114191053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD time_posted DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP time_posted');
        $this->addSql('ALTER TABLE screenshots CHANGE post_id post_id INT DEFAULT NULL');
